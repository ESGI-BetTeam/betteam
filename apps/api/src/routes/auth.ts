...
router.post(
  '/logout',
  requireAuth,
  async (req: AuthenticatedRequest, res: Response<LogoutResponse | { error: string }>) => {
    try {
...
router.post(
  '/forgot-password',
  async (
    req: Request<{}, {}, ForgotPasswordRequest.Body>,
    res: Response<ForgotPasswordResponse | { error: string }>,
  ) => {
    try {
...
router.post(
  '/reset-password',
  async (
    req: Request<{}, {}, ResetPasswordRequest.Body>,
    res: Response<ResetPasswordResponse | { error: string }>,
  ) => {
    try {
